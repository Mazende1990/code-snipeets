...
public class WebPropertiesGemini {
  ...
  public static class Resources {
    ...
    private static final StringDEFAULT_RESOURCE_LOCATIONS = {
    ...
    /**
     * Locations of static resources. Defaults to
     * classpath:[/META-INF/resources/, /resources/, /static/, /public/].
     */
    private StringstaticLocations = DEFAULT_RESOURCE_LOCATIONS;
    ...
    public StringgetStaticLocations() {
      return this.staticLocations;
    }

    public void setStaticLocations(StringstaticLocations) {
      this.staticLocations = appendSlashIfNecessary(staticLocations);
      this.customized = true;
    }

    private StringappendSlashIfNecessary(StringstaticLocations) {
      Stringnormalized = new String[staticLocations.length];
    ...
    public boolean hasBeenCustomized() {
      return this.customized || this.chain.hasBeenCustomized() || this.cache.hasBeenCustomized();
    }
    ...
    public static class Chain {
      ...
      /**
       * Whether to enable the Spring Resource Handling chain. By default, disabled unless at
      ...
      /**
       * Whether to enable resolution of already compressed resources (gzip, brotli). Checks for
       * a resource name with the '.gz' or '.br' file extensions.
       */
      ...
      /**
       * Return whether the resource chain is enabled. Return {@code null} if no specific
      ...
      public Boolean getEnabled() {
        return getEnabled(
            this.strategy.getFixed().isEnabled(),
            this.strategy.getContent().isEnabled(),
            this.enabled);
      }

      private boolean hasBeenCustomized() {
        return this.customized || this.strategy.hasBeenCustomized();
      }
      ...
      private static Boolean getEnabled(
          boolean fixedStrategyEnabled, boolean contentStrategyEnabled, Boolean chainEnabled) {
        return fixedStrategyEnabled || contentStrategyEnabled ? Boolean.TRUE : chainEnabled;
      }
      ...
      public static class Strategy {
        ...
        private boolean hasBeenCustomized() {
          return this.fixed.hasBeenCustomized() || this.content.hasBeenCustomized();
        }
        ...
        public static class Content {
          ...
          private Stringpaths = new String{"/**"};
          ...
          public StringgetPaths() {
            return this.paths;
          }

          public void setPaths(Stringpaths) {
            this.customized = true;
            this.paths = paths;
          }
    ...
    public static class Cache {
      ...
      /**
       * Cache period for the resources served by the resource handler. If a duration suffix is
       * not specified, seconds will be used. Can be overridden by the
       ...
       * 'spring.web.resources.cache.period' property.
       */
      ...
      private boolean hasBeenCustomized() {
        return this.customized || this.cachecontrol.hasBeenCustomized();
      }
      ...
      public static class Cachecontrol {
        ...
        /**
         * Maximum time the response should be cached, in seconds if no duration suffix is not
         * specified.
         */
        @DurationUnit(ChronoUnit.SECONDS)
        ...
        /**
         * Indicate that once it has become stale, a cache must not use the response without
         * re-validating it with the server.
         */
        ...
        /**
         * Indicate that the response message is intended for a single user and must not be
        ...
        /**
         * Maximum time the response can be served after it becomes stale, in seconds if no
        ...
        /**
         * Maximum time the response may be used when errors are encountered, in seconds if no
         * duration suffix is not specified.
         */
        @DurationUnit(ChronoUnit.SECONDS)
